...
{
    internal class Cosine : SingleArgumentSymbol
    {
        public Cosine(Symbol argument)
            : base(argument)
        {
        }
        ...
        {
            return -(new Sine(this.Argument)) * this.Argument.Diff(variable); ;
        }
        ...
        {
            return string.Format("cos({0})", argument);
        }
    }
}
